...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        logoname.setText("NOME DA EMPRESA");
        ...
        userTxt.setText("Digite o seu usário");
        ...
        loginBtn.setBackground(new java.awt.Color(64, 81, 182));

        loginBtnTxt.setBackground(new java.awt.Color(64, 81, 182));
    ...
    private void loginBtnTxtMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginBtnTxtMouseEntered
        loginBtn.setBackground(new Color(55, 70, 155));
    }//GEN-LAST:event_loginBtnTxtMouseEntered

    private void loginBtnTxtMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginBtnTxtMouseExited
        loginBtn.setBackground(new Color(64, 81, 182));
    }//GEN-LAST:event_loginBtnTxtMouseExited

    private void userTxtMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_userTxtMousePressed
        if (userTxt.getText().equals("Digite o seu usário")) {
            userTxt.setText("");
    ...
    private void login() {
        ...
        if (user.isEmpty() || user.equals("Digite o seu usário")) {
            Notification ntt = new Notification(this, Notification.Type.INFO, Notification.Location.CENTER, "Insira um usário");
            ntt.showNotification();
            return;
        }
        if (password.isEmpty() || password.equals("********")) {
            Notification ntt = new Notification(this, Notification.Type.INFO, Notification.Location.CENTER, "Insira uma senha");
            ntt.showNotification();
            return;
        }

        ModelUser us = new ControllerUsuario().getUser(this, user, password);
